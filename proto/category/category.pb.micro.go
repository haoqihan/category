...
type CategoryService interface {
	...
	FindCategoryByLevel(ctx context.Context, in *FindByLevelRequest, opts ...client.CallOption) (*FindAllCategoryResponse, error)
	FindCategoryParent(ctx context.Context, in *FindByParentRequest, opts ...client.CallOption) (*FindAllCategoryResponse, error)
	FindAllCategory(ctx context.Context, in *FindAllRequest, opts ...client.CallOption) (*FindAllCategoryResponse, error)
}
...
func (c *categoryService) FindCategoryByLevel(ctx context.Context, in *FindByLevelRequest, opts ...client.CallOption) (*FindAllCategoryResponse, error) {
...
func (c *categoryService) FindCategoryParent(ctx context.Context, in *FindByParentRequest, opts ...client.CallOption) (*FindAllCategoryResponse, error) {
	req := c.c.NewRequest(c.name, "Category.FindCategoryParent", in)
	out := new(FindAllCategoryResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (c *categoryService) FindAllCategory(ctx context.Context, in *FindAllRequest, opts ...client.CallOption) (*FindAllCategoryResponse, error) {
...
type CategoryHandler interface {
	...
	FindCategoryByLevel(context.Context, *FindByLevelRequest, *FindAllCategoryResponse) error
	FindCategoryParent(context.Context, *FindByParentRequest, *FindAllCategoryResponse) error
	FindAllCategory(context.Context, *FindAllRequest, *FindAllCategoryResponse) error
}
...
func RegisterCategoryHandler(s server.Server, hdlr CategoryHandler, opts ...server.HandlerOption) error {
	type category interface {
		...
		FindCategoryByLevel(ctx context.Context, in *FindByLevelRequest, out *FindAllCategoryResponse) error
		FindCategoryParent(ctx context.Context, in *FindByParentRequest, out *FindAllCategoryResponse) error
		FindAllCategory(ctx context.Context, in *FindAllRequest, out *FindAllCategoryResponse) error
	}
...
func (h *categoryHandler) FindCategoryByLevel(ctx context.Context, in *FindByLevelRequest, out *FindAllCategoryResponse) error {
	return h.CategoryHandler.FindCategoryByLevel(ctx, in, out)
}

func (h *categoryHandler) FindCategoryParent(ctx context.Context, in *FindByParentRequest, out *FindAllCategoryResponse) error {
	return h.CategoryHandler.FindCategoryParent(ctx, in, out)
}

func (h *categoryHandler) FindAllCategory(ctx context.Context, in *FindAllRequest, out *FindAllCategoryResponse) error {
